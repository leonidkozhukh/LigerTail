...
function AddEvents(){
	jQuery(".content").bind("show", function(){
		...
		jQuery.ajax({
			type: "POST",
			url: "event_tracking.php?location=" + location.href + "&event=viewed&content_id=" + jQuery(this).attr("id"),
			//data: "location=" + location.href + "&event=viewed&content_id=" + jQuery(this).attr("id"),
			success: function(){}
		});
	});
	...
	jQuery(".content .close").click(function(){
		...
		jQuery.ajax({
			type: "POST",
			url: "event_tracking.php?location=" + location.href + "&event=closed&content_id=" + jQuery(this).parent().attr("id"),
			//data: ({location: location.href, event: 'closed', content_id: jQuery(this).parent().attr("id")}),
			success: function(){}
		});
	...
	jQuery(".content a").click(function(){
		...
		jQuery.ajax({
			type: "POST",
			url: "event_tracking.php?location=" + location.href + "&event=clicked&content_id=" + jQuery(this).parent().attr("id"),
			//data: ({location: location.href, event: 'clicked', content_id: jQuery(this).parent().attr("id")}),
			success: function(){}
		});
	...
	jQuery(".content iframe").click(function(){ alert("event_tracking.php?location=" + location.href + "&event=liked&content_id=" + jQuery(this).parent().attr("id"));
		...
		jQuery.ajax({
			type: "POST",
			url: "event_tracking.php?location=" + location.href + "&event=liked&content_id=" + jQuery(this).parent().attr("id"),
			//data: ({location: location.href, event: 'liked', content_id: jQuery(this).parent().attr("id")}),
			success: function(){}
		});
...
function OpenAnalytics(id){
	jQuery.facebox(function(){ 	
		...
		jQuery.ajax({
			type: "GET",
			url: "get_analytics.php?type=views&location=" + location.href + "&id=" + id,
			dataType: "html",
		...
		jQuery.ajax({
			type: "GET",
			url: "get_analytics.php?type=clicks&location=" + location.href + "&id=" + id,
			dataType: "html",
			success: function(data){
		...
		jQuery.ajax({
			type: "GET",
			url: "get_analytics.php?type=closes&location=" + location.href + "&id=" + id,
			dataType: "html",
			success: function(data){
		...
		jQuery.ajax({
			type: "GET",
			url: "get_analytics.php?type=likes&location=" + location.href + "&id=" + id,
			dataType: "html",
			success: function(data){
...
function GetContent(){
	jQuery.ajax({
		type: "POST",
		data: "{publisherUrl: 'http://ligertail.com/meerror'}",
		url: "http://ligertailbackend.appspot.com/get_ordered_items",
		dataType: "json",
		success: function(d){ alert("content:" + d);
			var content = "";
			...
			jQuery(".widget_1").append(content);
			//AddEvents();
...
jQuery(document).ready(function($){
	...
	//LOAD INPUT FORM
	$(".widget_1").append('<div id="header"><input name="textfield2" type="text" class="form" id="textfield2" value="Submit Link" /><input type="submit" name="button2" id="button2" value="Submit" /></div><div id="footer"><img src="images/logo_footer.png" width="116" height="35" alt="Logo" /></div>');
	
	//Submit test
	$.ajax({
		type: "POST",
		data: "{url: 'www.itemurl.com/', title: 'first submission for LT', description: 'blah blah blah. this is the description', email: 'm@m.com', publisherUrl: 'http://ligertail.com/meerror/', price: '0'}",
		url: "http://ligertailbackend.appspot.com/submit_paid_item",
		dataType: "json",
...
/*
	...
	$("#button2").submit(function(){ //open lightbox & save input in db
		//event.preventDefault();
		var url = $(this).find("input:first").val();
		OpenLightbox(url);
	});
	
	//LOAD PAYMENT ACCEPTANCE	
