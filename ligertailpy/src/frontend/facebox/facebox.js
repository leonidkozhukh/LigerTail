...
(function(jq15) {
  ...
  jq15.extend(jq15.facebox, {
    settings: {
      opacity      : 0.4,
      overlay      : true,
      loadingImage : 'http://ligertailpayment.appspot.com/frontend/facebox/loading.gif',
      closeImage   : 'http://ligertailpayment.appspot.com/frontend/facebox/closelabel.gif',
          ...
          <tbody> \
            ...
            <tr> \
              ...
              <td class="body"> \
                ...
                <div class="footer"> \
                  <a href="#" class="close"> \
                    <img src="http://ligertailpayment.appspot.com/frontend/facebox/closelabel.gif" title="close" class="close_image" /> \
                  </a> \
                </div> \
              </td> \
              <td class="b"/> \
